    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FDF6E9] px-4 sm:px-6 py-8 sm:py-12">
      <div className="max-w-5xl w-full bg-[#FFF8EC] rounded-xl shadow-lg grid grid-cols-1 md:grid-cols-2 overflow-hidden">
        ...
        <div className="flex flex-col justify-center p-6 sm:p-8 md:p-12">
          <h2 className="text-2xl sm:text-3xl font-serif text-[#1E3D34] mb-2">
            Sign In
          </h2>
          <p className="text-xs sm:text-sm text-[#1C3A2C] mb-4 sm:mb-6">
          ...
          <input
            ...
            className="border border-gray-300 p-2.5 sm:p-3 rounded-md mb-3 sm:mb-4 focus:ring-1 focus:ring-[#1E3D34] outline-none text-sm sm:text-base"
          />

          <input
            type="password"
            placeholder="Password"
            className="border border-gray-300 p-2.5 sm:p-3 rounded-md mb-3 focus:ring-1 focus:ring-[#1E3D34] outline-none text-sm sm:text-base"
          />
          ...
          <button className="bg-[#1C3A2C] text-white py-2.5 sm:py-3 rounded-md hover:bg-[#0F231C] transition text-sm sm:text-base font-semibold">
            Sign In
          </button>
